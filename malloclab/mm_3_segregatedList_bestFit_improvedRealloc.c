/*
 * 使用分离空闲链表，最佳适配，改进的realloc版本
 *Results for mm malloc:
trace  valid  util     ops      secs  Kops
 0       yes   99%    5694  0.000257 22182
 1       yes   99%    5848  0.000293 19925
 2       yes   99%    6648  0.000207 32178
 3       yes  100%    5380  0.000175 30778
 4       yes   99%   14400  0.000183 78560
 5       yes   95%    4800  0.001064  4510
 6       yes   95%    4800  0.001057  4541
 7       yes   55%   12000  0.000380 31562
 8       yes   51%   24000  0.000870 27583
 9       yes   40%   14401  0.000374 38526
10       yes   45%   14401  0.000265 54364
Total          80%  112372  0.005125 21925
...
int mm_init(void)
{
	...
	PUT(heap_listp + (11 * WSIZE), PACK(DSIZE, 1));	// 8/1, 序言块头
	PUT(heap_listp + (12 * WSIZE), PACK(DSIZE, 1));	// 8/1, 序言块尾
	PUT(heap_listp + (13 * WSIZE), PACK(0, 1));	// 0/1, 结尾块hdr
